...
<form class="form-horizontal" action="<?php echo Config::getURL()?>/ow/blog" method="POST">
	...
	<div class="form-group">
		...
		<div class="col-sm-4">
			<input type="text" class="form-control" id="title" name="title" placeholder="Title" <?php if ($blogEntry) { echo "value=\"$blogEntry->title\""; } ?>>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		<div class="col-sm-10">
			<button type="submit" class="btn btn-primary"><?php if ($blogEntry) { echo "Update entry"; } else { echo "Add entry"; } ?></button>

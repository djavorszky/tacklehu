...
<div class="row">
	<a class="btn btn-primary" href="<?php echo Config::getURL("/blogadmin/edit")?>"><?php echo R::lang("add-entries") ?></a>
</div>
	<br>
<div class="row">
<?php
...
<table class="table table-striped table-hover table-responsive">
	...
	<tr>
		...
		<td>
			<form class="form-inline" action="<?php echo Config::getURL("/blogadmin")?>" method="POST">
